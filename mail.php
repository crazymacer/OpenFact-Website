...
// validate the variables ======================================================
    ...
    if (empty($_POST['user-name']))
        $errors['user_name'] = 'Debe ingresar un nombre de referencia.';
